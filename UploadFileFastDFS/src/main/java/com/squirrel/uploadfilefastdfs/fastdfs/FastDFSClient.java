package com.squirrel.uploadfilefastdfs.fastdfs;
...
public class FastDFSClient {
    ...
    public static String[] upload(FastDFSFile file) {
        ...
        try {
            ...
            logger.info("IO Exception: " + file.getName(), e);
        } catch (Exception e) {
            logger.info("Non IO Exception: " + file.getName(), e);
        }
        logger.info("upload file time used: " + (System.currentTimeMillis() - startTime) + "ms");

        if (uploadResults == null && storageClient != null) {
            logger.error("upload fail, error code: " + storageClient.getErrorCode());
        }

        logger.info(
                "upload group_name:" + uploadResults[0] + ", remoteFileName: " + uploadResults[1]);
    ...
    public static FileInfo getFile(String groupName, String remoteFileName) {
        try {
            ...
            logger.info("Non IO Exception: ", e);
        }
        return null;
    }
